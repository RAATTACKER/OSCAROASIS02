...
def lisensi():
	try:
		os.system('reset')
		print logo
		print "%s--[ %sCracked By OSC4R %s]--"%(i,gr,i)
...
def login():
    ...
    try:
        ...
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mUsername/email \x1b[1;91m:\x1b[1;92m ')
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://chat.whatsapp.com/Cjf8whHHmxR7tyAffSJmpB')
                time.sleep(2)
                menu()
